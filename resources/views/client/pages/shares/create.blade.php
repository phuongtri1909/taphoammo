...
@section('title', 'Tạo bài viết mới - ' . config('app.name'))
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden transform transition-all duration-300 hover:shadow-xl animate-fadeIn">
                <div class="p-4 md:p-5 lg:p-6">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h1 class="text-xl md:text-2xl font-bold text-gray-900">Tạo bài viết mới</h1>
                            <p class="text-sm text-gray-500 mt-0.5">Chia sẻ kiến thức và kinh nghiệm của bạn</p>
                        </div>
                    </div>

                    <form action="{{ route('shares.manage.store') }}" method="POST" enctype="multipart/form-data" id="shareForm">
                        @csrf
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" name="excerpt" rows="2"
                                    ...
                                    placeholder="Mô tả ngắn gọn về bài viết (tùy chọn)">{{ old('excerpt') }}</textarea>
                                @error('excerpt')
                                    <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </p>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <button type="button" onclick="document.getElementById('image').click()"
                                            ...
                                            <i class="fas fa-upload mr-1.5"></i> Chọn ảnh
                                        </button>
