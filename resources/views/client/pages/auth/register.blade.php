...
@section('header')
    <h2 class="text-2xl md:text-xl sm:text-lg font-semibold text-[#002740] mb-2">Đăng ký</h2>
...
@section('content')
    ...
    <div class="relative mb-6">
        ...
        <div class="mb-6">
            <label for="password_confirmation" class="block text-sm font-normal text-[#002740] mb-2">Xác nhận mật khẩu</label>
                            <div class="password-input-wrapper">
                <input type="password" class="w-full py-3.5 px-4 rounded-full border border-[#E7ECF1] bg-[#F8F9FB] text-sm text-primary-8 transition-all login-input @error('password_confirmation') border-red-500 @enderror" id="password_confirmation" name="password_confirmation" placeholder="Nhập lại mật khẩu" required>
    ...
    <div class="mt-6 text-center">
        <p class="text-sm font-normal text-[#7E899C] m-0">
                            Bạn đã có tài khoản? 
            <a href="{{ route('sign-in') }}" class="text-sm text-[#E82A00] underline font-medium transition-opacity register-link">Đăng nhập ngay.</a>
                        </p>
    </div>
@endsection
