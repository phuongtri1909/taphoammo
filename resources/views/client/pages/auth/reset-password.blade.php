...
<head>
    ...
    <title>Đặt lại mật khẩu - Nap PLUS</title>
        ...
        <div class="login-container">
            <div class="login-card">
                ...
                <div class="login-body">
                    ...
                    <form method="POST" action="{{ route('reset-password.post') }}" class="login-form">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="password-input-wrapper">
                                <input type="password" class="form-control login-input @error('password') is-invalid @enderror" id="password" name="password" placeholder="Nhập mật khẩu mới" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="password-input-wrapper">
                                <input type="password" class="form-control login-input @error('password_confirmation') is-invalid @enderror" id="password_confirmation" name="password_confirmation" placeholder="Nhập lại mật khẩu" required>
