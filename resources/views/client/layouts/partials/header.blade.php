<!-- Top Support Bar -->
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div class="flex w-full items-center justify-between space-x-2">
                <span class="flex items-center space-x-2">
                    <span class="hidden items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-800 ring-1 ring-inset ring-yellow-600/20 lg:flex">
                        Hỗ trợ trực tuyến:
                    </span>
                    <a href="https://facebook.com/shoptaphoazalo" target="_blank" class="hidden items-center space-x-1 rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10 md:flex hover:opacity-80 transition-opacity">
                        <i class="fab fa-facebook-f"></i>
                        <span>facebook.com/shoptaphoazalo</span>
                    </a>
                    <a href="mailto:shoptaphoazalo@gmail.com" class="hidden items-center space-x-1 rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 md:flex hover:opacity-80 transition-opacity">
                        <i class="fas fa-envelope"></i>
                        <span>shoptaphoazalo@gmail.com</span>
                    </a>
                </span>
                <span class="flex items-center space-x-2">
                    <span class="mr-auto rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
    ...
    <div class="sticky top-0 z-50 header-main" id="header">
            ...
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="relative flex h-14 items-center justify-between">
                    ...
                    <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
                        <button class="relative items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" id="mobileMenuToggle">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden items-center md:ml-6 md:flex">
                            <div class="flex space-x-3">
                                ...
                                <a href="#" class="rounded-3xl px-1 py-1 text-sm font-medium md:px-3 text-white hover:bg-primary hover:text-white nav-link">Liên hệ</a>
                                <a href="#" class="rounded-3xl px-1 py-1 text-sm font-medium md:px-3 text-white hover:bg-primary hover:text-white nav-link">Chia sẻ</a>
                                <a href="#" class="rounded-3xl px-1 py-1 text-sm font-medium md:px-3 text-white hover:bg-primary hover:text-white nav-link">FAQs</a>
                                @auth
                                    <a href="#" class="rounded-3xl px-1 py-1 text-sm font-medium md:px-3 text-white hover:bg-primary hover:text-white nav-link {{ !auth()->user() ? 'hidden' : '' }}">Nạp tiền</a>
                                @endauth
                            </div>
                        </div>
                    </div>
        ...
        <!-- Promotional Banner -->
        <div class="w-full overflow-hidden whitespace-nowrap bg-green-50 font-medium text-red-500 ring-1 ring-inset ring-green-600/20 promo-banner" id="promoBanner">
    ...
    <div class="fixed inset-0 bg-black/50 z-[1001] opacity-0 invisible transition-all duration-300 mobile-side-menu-overlay" id="mobileMenuOverlay"></div>

    <!-- Mobile Side Menu -->
    <div class="fixed top-0 -right-full w-[240px] max-w-[60%] h-screen bg-primary z-[1002] transition-[right] duration-300 shadow-[-2px_0_8px_rgba(0,0,0,0.1)] overflow-y-auto mobile-side-menu" id="mobileSideMenu">
        ...
        <div class="space-y-2 py-2">
            ...
            <div class="mobile-dropdown">
                <button class="flex w-full items-center justify-between border-b border-white/20 px-3 py-2 text-start text-sm font-medium text-white hover:bg-blue-900/90 mobile-dropdown-toggle">
                    <span>Sản phẩm</span>
                ...
                <div class="hidden mt-2 grid w-full grid-cols-2 gap-2 bg-blue-700 px-3 pb-2 mobile-dropdown-content">
                    <a href="#" class="text-start text-xs text-white hover:underline" onclick="closeMobileMenu()">Sub 1</a>
                    <a href="#" class="text-start text-xs text-white hover:underline" onclick="closeMobileMenu()">Sub 2</a>
                </div>
            </div>
            ...
            <a href="#" class="flex w-full flex-1 flex-col items-start border-b border-white/20 px-3 py-2 text-start text-sm font-medium text-white hover:bg-blue-900/90" onclick="closeMobileMenu()">Liên hệ</a>
            <a href="#" class="flex w-full flex-1 flex-col items-start border-b border-white/20 px-3 py-2 text-start text-sm font-medium text-white hover:bg-blue-900/90" onclick="closeMobileMenu()">Chia sẻ</a>
            <a href="#" class="flex w-full flex-1 flex-col items-start border-b border-white/20 px-3 py-2 text-start text-sm font-medium text-white hover:bg-blue-900/90" onclick="closeMobileMenu()">FAQs</a>
            @auth
                <a href="#" class="flex w-full flex-1 flex-col items-start border-b border-white/20 px-3 py-2 text-start text-sm font-medium text-white hover:bg-blue-900/90" onclick="closeMobileMenu()">Nạp tiền</a>
            @endauth
        </div>
    </div>
