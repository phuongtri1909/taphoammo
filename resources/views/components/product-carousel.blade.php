...
<div class="w-full py-8 bg-white">
    <div class="w-full max-w-7xl mx-auto px-2 md:px-0">
                    ...
                    <div class="swiper-slide">
                        <a href="{{ route('products.show', $product['id'] ?? 1) }}"
                            ...
                            <div class="p-4 flex flex-col flex-grow">
                                <h5 class="text-sm font-semibold mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="text-xs text-primary ml-1">{{ $product['subcategory'] ?? 'Subcategory' }}</span>
                                </div>
                                <div class="text-sm font-bold text-primary mt-auto">
                                    @if (isset($product['price_min']) && isset($product['price_max']) && $product['price_max'] != $product['price_min'])
                                        {{ number_format($product['price_min'] ?? 0, 0, ',', '.') }} - {{ number_format($product['price_max'] ?? 0, 0, ',', '.') }}
                                    @else
