...
@section('title', 'Tạo phiên đấu giá mới')
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea id="description" name="description" class="custom-textarea custom-input" rows="4">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mb-4">
                                ...
                                <select id="banner_position" name="banner_position" class="custom-select" required>
                                    <option value="left" {{ old('banner_position') === 'left' ? 'selected' : '' }}>Bên trái</option>
                                    <option value="right" {{ old('banner_position') === 'right' ? 'selected' : '' }}>Bên phải</option>
                                </select>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="number" id="starting_price" name="starting_price" class="custom-input" value="{{ old('starting_price') }}" min="0" step="1000" required>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="number" id="banner_duration_days" name="banner_duration_days" class="custom-input" value="{{ old('banner_duration_days', 7) }}" min="1" max="365" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="datetime-local" id="start_time" name="start_time" class="custom-input" value="{{ old('start_time') }}" required>
                                @error('start_time')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="datetime-local" id="end_time" name="end_time" class="custom-input" value="{{ old('end_time') }}" required>
                                @error('end_time')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
