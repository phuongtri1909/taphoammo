...
@section('main-content')
    <div class="category-container">
        <div class="content-card">
            <div class="card-top">
                <h2 class="page-title">Danh sách danh mục con</h2>
            ...
            <div class="card-content">
                @if ($subCategories->isEmpty())
                    <div class="empty-state">
                        ...
                        <p>Thêm danh mục con để phân loại sản phẩm chi tiết hơn</p>
                        ...
                        <table class="data-table">
                            <thead>
                                <tr class="text-center text-sm">
                                    ...
                                    <th class="column-small">Field Name</th>
                            ...
                            <tbody class="text-center text-sm">
                                @foreach ($subCategories as $key => $subCategory)
                                    <tr class="text-center">
                                            ...
                                            <div class="action-buttons-wrapper">
                                                ...
                                                @if ($subCategory->products_count === 0)
                                                    @include('components.delete-form', [
                                                        'id' => $subCategory->slug,
                                                        'route' => route('admin.subcategories.destroy', $subCategory),
                                        ...
                                        <td>
                                            @if ($subCategory->field_name)
                                                <code class="field-name-text">{{ $subCategory->field_name }}</code>
                                            @else
                                                ...
                                                <form
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select id="category_id{{ $subCategory->id }}"
                                                                name="category_id" class="custom-select" required>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            <label for="field_name{{ $subCategory->id }}"
                                                                class="form-label-custom">Field Name gợi ý</label>
                                                            <input type="text" id="field_name{{ $subCategory->id }}"
                                                                name="field_name" class="custom-input"
                                                                value="{{ $subCategory->field_name }}"
                                                                placeholder="VD: email, password, token...">
                                                            <div class="form-hint mt-1">
                                                                <i class="fas fa-info-circle"></i> Tên trường gợi ý cho
                                                                seller khi tạo sản phẩm
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="addSubCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content modal-content-custom">
                <div class="modal-header">
                    <h5 class="modal-title color-primary-6">Thêm danh mục con mới</h5>
                ...
                <form action="{{ route('admin.subcategories.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            <label for="category_id" class="form-label-custom">Danh mục cha <span
                                    class="required-mark">*</span></label>
                        ...
                        <div class="form-group mb-3">
                            <label for="field_name" class="form-label-custom">Field Name gợi ý</label>
                            <input type="text" id="field_name" name="field_name" class="custom-input"
                                placeholder="VD: email, password, token...">
                            <div class="form-hint mt-1">
                                <i class="fas fa-info-circle"></i> Tên trường gợi ý cho seller khi tạo sản phẩm
                            </div>
                        </div>
