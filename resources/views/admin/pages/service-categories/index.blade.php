...
@section('main-content')
    <div class="category-container">
        <div class="content-card">
            <div class="card-top">
                <h2 class="page-title">Danh sách danh mục dịch vụ</h2>
            ...
            <div class="card-content">
                @if ($categories->isEmpty())
                    <div class="empty-state">
                        ...
                        <p>Thêm danh mục để bắt đầu quản lý dịch vụ</p>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                ...
                                                @if ($category->service_sub_categories_count === 0)
                                                    @include('components.delete-form', [
                                                        'id' => $category->slug,
                                                        'route' => route('admin.service-categories.destroy', $category),
                                        ...
                                        <td>
                                            <span class="badge bg-info">{{ $category->service_sub_categories_count }}</span>
                                        </td>
                                    ...
                                    <div class="modal fade" id="editCategoryModal{{ $category->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content modal-content-custom">
                                                ...
                                                <form action="{{ route('admin.service-categories.update', $category) }}"
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content modal-content-custom">
                <div class="modal-header">
                    <h5 class="modal-title color-primary-6">Thêm danh mục dịch vụ mới</h5>
