                                        ...
                                        <optgroup label="{{ $category->name }}">
                                            @foreach ($category->serviceSubCategories as $subCategory)
                                                <option value="{{ $subCategory->id }}"
                                                    {{ old('service_sub_category_id') == $subCategory->id ? 'selected' : '' }}>
                                                    {{ $subCategory->name }}
                                                </option>
                                            @endforeach
                                        </optgroup>
                    ...
                    <div class="content-card">
                        ...
                        <div class="card-content">
                            <div class="form-hint mb-3">
                                <i class="fas fa-info-circle"></i> Mỗi dịch vụ cần có ít nhất 1 biến thể với tên và giá
                            </div>
                    ...
                    <div class="content-card sticky-top" style="top: 20px;">
                        <div class="card-content">
                            ...
                            <div class="alert alert-info mb-4">
                                ...
                                Dịch vụ sẽ được gửi đến admin để duyệt.
                            </div>

                            <button type="submit" class="btn action-button w-100">
                                <i class="fas fa-paper-plane"></i> Gửi duyệt dịch vụ
                            </button>
                        </div>
                    </div>
                </div>
