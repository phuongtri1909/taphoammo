...
@section('title', 'Đơn hàng dịch vụ')

@section('main-content')
    <div class="category-container">
        <div class="content-card">
            <div class="card-top">
                <h2 class="page-title">Đơn hàng dịch vụ đã bán</h2>
            </div>
            <div class="card-content">
                <form action="{{ route('seller.service-orders.index') }}" method="GET" class="filter-form mb-4">
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            <label class="form-label-custom small">Tìm kiếm</label>
                            <input type="text" name="search" class="custom-input" placeholder="Order, buyer, service..."
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="status" class="custom-select">
                                ...
                                <option value="paid" {{ request('status') === 'paid' ? 'selected' : '' }}>Đã thanh toán (Chờ xử lý)</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('seller.service-orders.show', $order->slug) }}"
                                        ...
                                        <td class="text-start">
                                            @if($order->serviceVariant && $order->serviceVariant->service)
                                                <a class="text-primary" href="{{ route('seller.services.show', $order->serviceVariant->service->slug) }}">
