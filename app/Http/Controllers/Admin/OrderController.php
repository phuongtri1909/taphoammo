...
class OrderController extends Controller
{
    ...
    {
        $query = Order::with(['buyer', 'seller', 'items.productVariant.product'])
            ->latest();
        ...
        $sellerIds = Order::distinct()->pluck('seller_id')->toArray();
        ...
        return view('admin.pages.orders.index', compact('orders', 'sellers'));
    }
